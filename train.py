...
parser.add_argument(
    "--beta_1", type=float, default=0.5, help="beta_1 value for Adam optimizer"
)
parser.add_argument(
    "--beta_2", type=float, default=0.999, help="beta_2 value for Adam optimizer"
)
parser.add_argument(
    "--data_dir",
    type=str,
...
parser.add_argument(
    "--save_best", type=int, default=2, help="number of k best models to save"
)
